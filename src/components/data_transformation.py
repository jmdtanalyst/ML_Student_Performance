...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info(f"Applying StandardScaler on Numerical features: {numerical_columns}")   
            # num_pipeline will handle numerical features
            num_pipeline=Pipeline(
                steps=[

                    # this step will handle missig values by using median
            ...
            logging.info(f"Applying HotEncoding and StandardScaler on categorical features {categorical_columns}")   
            # num_pipeline will handle categorical features
            cat_pipeline=Pipeline(
                steps=[
                    # this step will handle missig values by using most_frequent
                    ("imputer", SimpleImputer(strategy='most_frequent')),

                    # this step will encoder the data by applying OneHotEncoder
